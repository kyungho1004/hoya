...
FOOTER_CAFE = "📱 모바일 줄꼬임 방지 · 암별·소아·희귀암 패널 + 감염질환 표 포함 · 공식카페: https://cafe.naver.com/bloodmap"
...
LBL_Ca="Ca(칼슘)"; LBL_P="P(인)"; LBL_Na="Na(나트륨)"; LBL_K="K(포타슘)"; LBL_Alb="Albumin(알부민)"
LBL_Glu="Glucose(혈당)"; LBL_TP="Total Protein(총단백질)"; LBL_AST="AST(간수치)"; LBL_ALT="ALT(간세포수치)"
LBL_LDH="LDH(유산탈수효소)"; LBL_CRP="CRP(염증수치)"; LBL_Cr="Cr(신장수치)"; LBL_UA="UA(요산수치)"
LBL_TB="TB(총빌리루빈)"; LBL_BUN="BUN(신장수치)"; LBL_BNP="BNP(심장척도)"
...
FONT_PATH_REG="fonts/NanumGothic-Regular.ttf"; FONT_PATH_B="fonts/NanumGothic-Bold.ttf"; FONT_PATH_XB="fonts/NanumGothic-ExtraBold.ttf"
