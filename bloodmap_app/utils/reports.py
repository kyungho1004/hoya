...
def md_to_pdf_bytes_fontlocked(md_text: str) -> bytes:
    # Try to use reportlab; if unavailable, raise FileNotFoundError that the app handles gracefully.
    try:
        ...
        raise FileNotFoundError("PDF 생성용 폰트/모듈이 없습니다. (reportlab 필요)")  # handled upstream
